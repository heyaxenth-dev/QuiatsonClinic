                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <button data-reschedule-id="<?=$row['id']?>" class="dropdown-item reschedule-appointment text-info">
                                                        <i class="bi bi-clock-history"></i> Reschedule
                                                    </button>
                                                </li>
                                                <li>
                                                    <button data-cancel-id="<?=$row['id']?>" class="dropdown-item cancel-appointment text-danger">
                                                ...
                                                <li>
                                                    <button data-conclude-id="<?=$row['id']?>" class="dropdown-item text-success conclude-appointment">
