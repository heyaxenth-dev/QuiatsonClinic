                    ...
                    <div class="card-body">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM appointments WHERE appointment_date = CURDATE() AND status NOT IN ('Concluded', 'Cancelled') AND patient_type = 'senior_pwd' AND (severity = 'Urgent' OR severity = 'Regular') ORDER BY time_slot ASC, created_at ASC";
