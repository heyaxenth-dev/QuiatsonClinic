...
<head>
    ...
    <title>Forgot Password - Quiatson Clinic</title>
                ...
                <div class="col-md-7">
                    <div class="card shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">Enter your registered mobile number to receive an OTP via SMS. After
                                receiving the code, proceed to verification.</p>
